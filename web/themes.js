...
// ⚠ Wer hier eine Var ergänzt, MUSS sie auch in JEDER Palette unten setzen (Theme-Wechsel setzt nur bekannte
// Keys) UND in TouchDeck `THEME_VAR_KEYS` + service.py `_THEME_VAR_KEYS` (Apply/Sanitize) + als :root-Default
// in der Host-CSS (Cockpit touch.css/styles.css) führen. Sonst greift der Wert nicht überall.
export const THEME_VARS = [
  ...
  { key: '--live', label: 'Live' },
  { key: '--off', label: 'Inaktiv / Aus' },
  { key: '--vu-low', label: 'VU Pegel (unten)' },
  { key: '--vu-mid', label: 'VU Warnung (Mitte)' },
  { key: '--vu-high', label: 'VU Spitze (oben)' },
]
...
// --off = Inaktiv-/Aus-Farbe (Kachel-Glow inaktiver Tasten). --vu-* = die 3 VU-Zonen (unten/Warnung/Spitze),
// per Default = ok/warn/err der Palette, aber unabhängig editierbar.
export const THEME_PRESETS = [
  ...
  { id: 'green', name: 'Signal Green', vars: {
    ...
    '--off': '#2a3d31', '--vu-low': '#3ecf8e', '--vu-mid': '#ffb454', '--vu-high': '#ff6b6b' } },
  { id: 'amber', name: 'Amber Forge', vars: {
    ...
    '--off': '#3d3325', '--vu-low': '#3ecf8e', '--vu-mid': '#ffcf6b', '--vu-high': '#ff6b6b' } },
  { id: 'oled', name: 'OLED-Schwarz', vars: {
    ...
    '--ok': '#3ecf8e', '--warn': '#ffb454', '--err': '#ff6b6b', '--live': '#ff4d6d',
    '--off': '#2a2a2a', '--vu-low': '#3ecf8e', '--vu-mid': '#ffb454', '--vu-high': '#ff6b6b' } },
  { id: 'gold', name: 'RitschyRigz Gold', vars: {
    ...
    '--ok': '#3ecf8e', '--warn': '#ffcf6b', '--err': '#ff6b6b', '--live': '#ff4d6d',
    '--off': '#3a3320', '--vu-low': '#3ecf8e', '--vu-mid': '#ffcf6b', '--vu-high': '#ff6b6b' } },
  { id: 'crimson', name: 'Crimson', vars: {
    ...
    '--off': '#3f2a2e', '--vu-low': '#3ecf8e', '--vu-mid': '#ffb454', '--vu-high': '#ff5d5d' } },
  { id: 'synthwave', name: 'Synthwave', vars: {
    ...
    '--off': '#34284f', '--vu-low': '#2bd9a6', '--vu-mid': '#ffb454', '--vu-high': '#ff5d8a' } },
  { id: 'nord', name: 'Nord', vars: {
    ...
    '--off': '#434c5e', '--vu-low': '#a3be8c', '--vu-mid': '#ebcb8b', '--vu-high': '#bf616a' } },
  { id: 'dracula', name: 'Dracula', vars: {
    ...
    '--off': '#454758', '--vu-low': '#50fa7b', '--vu-mid': '#f1fa8c', '--vu-high': '#ff5555' } },
  { id: 'rose', name: 'Rosé', vars: {
    ...
    '--off': '#3c2b34', '--vu-low': '#3ecf8e', '--vu-mid': '#ffb454', '--vu-high': '#ff6b6b' } },
  { id: 'mint', name: 'Mint', vars: {
    ...
    '--off': '#234038', '--vu-low': '#34d399', '--vu-mid': '#ffcf6b', '--vu-high': '#ff6b6b' } },
  { id: 'mono', name: 'Mono', vars: {
    ...
    '--off': '#34343a', '--vu-low': '#8fd6a8', '--vu-mid': '#d8c48a', '--vu-high': '#d68a8a' } },
]
